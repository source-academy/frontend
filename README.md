...
1. Install the current LTS version of Node.js. The current version (usually the version one greater than the current LTS) may also work, but if you encounter issues, use the current LTS. **(17/1/2023) Latest LTS version (v18) results in compilation errors when using "yarn install". Recommended to downgrade to v16**  
