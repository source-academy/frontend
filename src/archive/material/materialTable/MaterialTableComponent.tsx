...
export interface IMaterialTableProps
  extends IMaterialTableDispatchProps,
    IMaterialTableStateProps {}
...
interface IMaterialTableStateProps {
...
type State = {
  // ColDef is defined within the state for easier manipulation.
  columnDefs: ColDef[];
  dialogOpen: boolean;
  filterValue: string;
