...
import { IAssessmentWorkspaceOwnProps } from '../assessmentWorkspace/AssessmentWorkspaceComponent';
...
export interface IAssessmentProps extends IAssessmentDispatchProps,
    IAssessmentOwnProps,
    ...
    public render() {
        ...
        if (assessmentOverviews === undefined) {
            ...
            const upcomingCards = this.sortAssessments(
                ...
                this.makeOverviewCard(overview, index, !isStudent, false)
            );
