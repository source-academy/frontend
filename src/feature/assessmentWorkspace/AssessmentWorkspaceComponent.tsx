...
export interface IAssessmentWorkspaceProps extends IAssessmentWorkspaceDispatchProps,
    IAssessmentWorkspaceStateProps, IAssessmentWorkspaceOwnProps { }
...
class AssessmentWorkspace extends React.Component<IAssessmentWorkspaceProps,
