...
const ChatBox: React.FC<ChatBoxProps> = ({ getChapter, getText }) => {
  ...
  function getPrompt() {
    const text = getText();
    const prompt ='You are a competent tutor, assisting a student who is learning computer science following the textbook "Structure and Interpretation of Computer Programs,' +
