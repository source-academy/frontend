...
const SicpWorkspace: React.FC<PlaygroundProps> = ({
  ...
  const shareButton = React.useMemo(() => {
    const queryString = Links.playground + '#' + props.initialEditorValueHash;
    return (
  ...
  }, [dispatch, props.initialEditorValueHash, props.shortURL]);
