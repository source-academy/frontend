...
const locationNames: string[] = ['Crash Site', 'Class Room', 'Emergency', 'Hallway', 'Student Room'];
const locationModes: GameMode[][] = [[GameMode.Talk], [GameMode.Explore, GameMode.Talk], [GameMode.Talk], [], [GameMode.Explore]];
