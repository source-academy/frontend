  ...
  >
    <div className={Classes.DIALOG_BODY}>
      ...
      <p>
        ...
        <b>Firefox</b>, Version 68 or higher, to visit the Source Academy. If you encounter issues
        with the Source Academy using these browsers, please use the following resources.
      </p>
      <ul>
        <li>
