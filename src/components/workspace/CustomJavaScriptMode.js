...
export class CustomHighlightRules extends window.ace.acequire(
  ...
  constructor() {
    ...
    var DocCommentHighlightRules = window.ace.acequire("ace/mode/doc_comment_highlight_rules").DocCommentHighlightRules;
...
export default class CustomJavaScriptMode extends window.ace.acequire("ace/mode/text")
  .Mode {
  constructor() {
    super();
