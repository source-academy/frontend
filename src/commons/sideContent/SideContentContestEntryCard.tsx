...
const SideContentContestEntryCard: React.FunctionComponent<SideContentConstestEntryCardProps> = props => {
    const { handleContestEntryClick, handleVotingSubmissionChange,
        votingSubmission, contestEntry, maxRank } = props; 
    ...
    return (
        <div className={classNames('ContestEntryCard')}>
            <Card 
                ...
                onClick={() => handleContestEntryClick(
                ...
                <Pre className='contestentry-rank'>
                    <NumericInput
                        ...
                        onValueChange={(rank : number) => handleVotingSubmissionChange(
                            contestEntry.studentUsername,
                            rank
                        )}
                        min={1}
