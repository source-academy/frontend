...
const contestEntryTooltipContent = (numOfEntries: number) => (
    <span>
        Rank your favourite contest entries from 1 to {numOfEntries}!
    </span>
)
...
const SideContentContestVoting : React.FunctionComponent<SideContentContestVotingProps> = props => {
    const { contestEntries, votingSubmission, 
        handleContestEntryClick, handleVotingSubmissionChange } = props; 
