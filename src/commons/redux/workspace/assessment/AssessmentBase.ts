...
export const assessmentActions = addLocation<typeof assessmentActionsInternal, AssessmentLocations>(
  assessmentActionsInternal
);
...
>(
  ...
  createWorkspaceSlice<TState, TReducers, TName>(name, initialState, reducers, builder => {
