...
// TODO: Fix the tests
// Failing old tests have been commented out
...
//       .not.put.like({ action: { type: UPDATE_EDITOR_VALUE } })
//       .not.put.like({ action: { type: CHAPTER_SELECT } })
//       .not.put.like({ action: { type: CHANGE_EXTERNAL_LIBRARY } })
//       .silentRun();
//   });
