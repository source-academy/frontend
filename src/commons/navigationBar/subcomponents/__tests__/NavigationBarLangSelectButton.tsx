...
describe('NavigationBarLangSelectButton', () => {
    ...
    it('should call selectLang with "Scheme" when "Scheme" menu item is clicked', () => {
        ...
        console.log(wrapper.findWhere(node => node.type() === 'li' && node.text() === 'Scheme').debug());
        wrapper.findWhere(node => node.type() === 'li' && node.text() === 'Scheme')
    ...
    it('should call selectLang with "Python" when "Python" menu item is clicked', () => {
        ...
        wrapper.find('button').simulate('click');
        wrapper.findWhere(node => node.type() === 'li' && node.text() === 'Python')
        .find('a[role="menuitem"]')
        .simulate('click');
    ...
    it('should call selectLang with "Source" when "Source" menu item is clicked', () => {
        ...
        wrapper.find('button').simulate('click');
        wrapper.findWhere(node => node.type() === 'li' && node.text() === 'Source')
        .find('a[role="menuitem"]')
        .simulate('click');
