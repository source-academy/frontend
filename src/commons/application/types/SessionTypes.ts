...
export const SET_GITHUB_LOGIN_ID = 'SET_GITHUB_LOGIN_ID';
export const SET_GITHUB_NAME = 'SET_GITHUB_NAME';
export const SET_GITHUB_EMAIL = 'SET_GITHUB_EMAIL';
...
export const SET_GITHUB_FILEPATH = 'SET_GITHUB_FILEPATH';
...
export const SET_PICKER_DIALOG_STATUS = 'SET_PICKER_DIALOG_STATUS';
