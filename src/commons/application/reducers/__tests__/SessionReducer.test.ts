...
import { Role, defaultSession, type GameState, type Story } from '../../ApplicationTypes';
...
describe(CommonsActions.logOut.type, () => {
  it('works correctly on default session', () => {
    const action = {
...
describe(SessionActions.setTokens.type, () => {
  it('sets accessToken and refreshToken correctly', () => {
...
describe(SessionActions.updateAssessment.type, () => {
  ...
  it('works correctly in inserting assessment', () => {
    const action = {
  ...
  it('works correctly in inserting assessment and retains old data', () => {
  ...
  it('works correctly in updating assessment', () => {
    const assessments: { [id: number]: Assessment } = {};
...
describe(SessionActions.updateAssessmentOverviews.type, () => {
  ...
  it('works correctly in inserting assessment overviews', () => {
    const action = {
  ...
  it('works correctly in updating assessment overviews', () => {
    const newDefaultSession = {
      ...defaultSession,
      assessmentOverviews: assessmentOverviewsTest1
    };
...
describe(SessionActions.updateGrading.type, async () => {
  ...
  it('works correctly in inserting gradings', () => {
  ...
  it('works correctly in inserting gradings and retains old data', () => {
  ...
  it('works correctly in updating gradings', () => {
    const submissionId = 23;
    const gradings: { [id: number]: GradingQuery } = {};
...
describe(SessionActions.updateGradingOverviews.type, () => {
  ...
  it('works correctly in inserting grading overviews', () => {
    const action = {
  ...
  it('works correctly in updating grading overviews', () => {
    const newDefaultSession = {
      ...defaultSession,
      gradingOverviews: {
        count: gradingOverviewTest1.length,
...
describe(SessionActions.updateNotifications.type, () => {
  it('works correctly in updating notifications', () => {
