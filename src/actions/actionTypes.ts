...
export const SET_SOURCECAST_PLAYBACK_IS_PLAYING = 'SET_SOURCECAST_PLAYBACK_IS_PLAYING';

/** Sourcecast Recording */
export const RECORD_EDITOR_INPUT = 'RECORD_EDITOR_INPUT';
export const SET_SOURCECAST_IS_RECORDING = 'SET_SOURCECAST_IS_RECORDING';
