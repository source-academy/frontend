...
export const SET_SOURCECAST_PLAYBACK_DATA = 'SET_SOURCECAST_PLAYBACK_DATA';
export const LOAD_PLAYBACK_DATA = 'LOAD_PLAYBACK_DATA';
export const SET_DELTAS_TO_APPLY = 'SET_DELTAS_TO_APPLY';
...
export const UPDATE_EDITOR_CURSOR_POSITION = 'UPDATE_EDITOR_CURSOR_POSITION';
export const UPDATE_EDITOR_SELECTION_RANGE = 'UPDATE_EDITOR_SELECTION_RANGE';

/** Sourcereel */
export const RECORD_AUDIO_URL = 'RECORD_AUDIO_URL';
export const RECORD_EDITOR_DELTA = 'RECORD_EDITOR_DELTA';
export const RECORD_EDITOR_INIT_VALUE = 'RECORD_EDITOR_INIT_VALUE';
export const SAVE_PLAYBACK_DATA = 'SAVE_PLAYBACK_DATA';
