...
Interpretation of Computer Programs, JavaScript Adaptation_](${LINKS.TEXTBOOK}) You have chosen the sublanguage `;
...
const generateSourceDocsLink = (sourceType: string) => {
  switch (sourceType) {
    case '1 default':
      return `[_Source ${CHAP}1](${LINKS.SOURCE_1}),`;
    case '1 wasm':
      return `[_Source ${CHAP}1 WebAssembly_](${LINKS.SOURCE_1_WASM}),`;
    case '1 lazy':
      return `[_Source ${CHAP}1 Lazy_](${LINKS.SOURCE_1_LAZY}),`;
    case '2 default':
      return `[_Source ${CHAP}2_](${LINKS.SOURCE_2}).`;
    case '2 lazy':
      return `[_Source ${CHAP}2 Lazy_](${LINKS.SOURCE_2_LAZY}).`;
    case '3 default':
      return `[_Source ${CHAP}3_](${LINKS.SOURCE_3}).`;
    case '3 non-det':
      return `[_Source ${CHAP}3 Non-Det_](${LINKS.SOURCE_3_NONDET}).`;
    case '3 concurrent':
      return `[_Source ${CHAP}3 Concurrent_](${LINKS.SOURCE_3_CONCURRENT}).`;
    case '4 default':
      return `[_Source ${CHAP}4_](${LINKS.SOURCE_4}).`;
    case '4 gpu':
      return `[_Source ${CHAP}4 GPU_](${LINKS.SOURCE_4_GPU})`;
    default:
      return '';
  }
};
