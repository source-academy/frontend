...
export class Layout {
  ...
  /** memoized values */
  static values = new Map<DataArray | Closure | GlobalFn, Value>();
  /** memoized layout */
  ...
  private static removeUnreferencedGlobalFns(): void {
    const referencedFns = new Set<GlobalFn>();
    ...
    // and also add any closures created in the global frame
