...
function EditStoryCell(props: Props) {
  ...
  return (
    ...
    >
      {showNewCellUp && <NewStoryCell index={props.index} />}
      {isEditMode && (
        <div style={{ margin: '0px', backgroundColor: '#2c3e50', padding: '5px' }}>
      ...
      {showNewCellDown && <NewStoryCell index={props.index + 1} />}
