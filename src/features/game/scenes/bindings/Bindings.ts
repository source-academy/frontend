...
import { bindingConstants, keyStyle, keyDescStyle } from "./BindingsConstants";
...
class Bindings extends Phaser.Scene {
    ...
    private createBinding(key: string, desc: string, xPos: number, yPos: number) {
        ...
        const keyIcon = new Phaser.GameObjects.Sprite(this, bindingConstants.keyIconXPos, 0, 'defaultKeyIcon');
        switch (key) {
            case 'Tab':
