...
export const uploadAssessment = (file: File, forceUpdate: boolean, hasTokenCounter: boolean, assessmentConfigId: number) =>
  action(UPLOAD_ASSESSMENT, { file, forceUpdate, hasTokenCounter, assessmentConfigId });
