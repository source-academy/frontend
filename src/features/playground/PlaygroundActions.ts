...
import {
  ...
  PLAYGROUND_UPDATE_INTERNATIONAL_LANGUAGE_CONFIG,
...
export const playgroundInternationalLanguage = (language: InternationalLanguage) =>
  action(PLAYGROUND_UPDATE_INTERNATIONAL_LANGUAGE_CONFIG, language);
